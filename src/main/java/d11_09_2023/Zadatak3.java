...
public class Zadatak3 {
    ...
    public static void main(String[] args) {
        ...
        Video video = new Video("rgCrARqNyuM", "Cali Y El Dandee - Como Ayer", 164);
        ...
        youtubePlayer.soundVolumeUp();
        youtubePlayer.soundVolumeUp();
        youtubePlayer.soundVolumeUp();
        youtubePlayer.soundVolumeUp();

        youtubePlayer.soundVolumeDown();

        youtubePlayer.setVideoQuality(10);

        youtubePlayer.fullScreenModeOn();
        ...
        youtubePlayer.printPlayer();

        System.out.println(youtubePlayer.shareVideo());
