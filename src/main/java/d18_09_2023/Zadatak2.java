...
public class Zadatak2 {
    ...
    public static void main(String[] args) {
        EmailValidator email = new EmailValidator("pera@gmail.co");
        PasswordValidator password = new PasswordValidator("-----");
        PhoneValidator phone = new PhoneValidator("456 321p");

        ValidationResult validationResult1 = email.validate();
        ValidationResult validationResult2 = password.validate();
        ValidationResult validationResult3 = phone.validate();

        validationResult1.print();
        validationResult2.print();
        validationResult3.print();
    }
}
