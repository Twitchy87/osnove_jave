...
public class Zadatak1 {
    ...
    public static void main(String[] args) {
        ...
        VisaKartica visaKartica = new VisaKartica(5000, "123-45698-87", 25, 7, "Pera Peric");

        MasterKartica masterKartica = new MasterKartica(6500, "987-56412-98", 24, 6);
        ...
        masterKartica.izvrsiTransakciju(1000);
